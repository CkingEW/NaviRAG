def get_query_instruction(linking_method):
    instructions = {
        ...
        'fact_to_fact': 'Given the triplet facts extracted from a question, retrieve relevant triplet facts from the knowledge graph.',
        'query_to_sentence': 'Given a question, retrieve relevant sentences that best answer the question.',
        'query_to_passage': 'Given a question, retrieve relevant passages that best answer the question.',
    }
    default_instruction = 'Given a question, retrieve relevant passages that best answer the question.'
